  ...
  const classData = [
    {
      ...
      description: 'Learn basic steps, mudras, and rhythms for a strong foundation.',
      image: bharatanatyamClasses1,
    },
    {
      id: 2,
      title: 'Intermediate Batch',
      description: 'Improve stamina and master jathis, adavus, and expressions.',
      image: bharatanatyamClasses2,
    },
    {
      id: 3,
      title: 'Advanced Batch',
      description: 'Refine abhinaya and perform complete margams with confidence.',
  ...
  const reviews = [
    {
      ...
      date: 'March 2024',
      rating: 5,
      comment: 'Amazing experience! The instructors are highly skilled and very patient.',
    ...
    },
    {
      ...
      date: 'June 2024',
      rating: 5,
      comment: 'The online classes are just as effective as in-person. Thank you!',
      avatar: bharatanatyamClasses2,
    },
  ];
  ...
  return (
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6" data-aos="fade-left">
            ...
            <p className="text-secondary fs-6 lh-lg text-justify">
              ...
              not just about mastering movements; it is a journey into discipline, expression, and
              cultural appreciation. This dance form enhances physical flexibility, improves
              concentration, and promotes mental well-being. Students gain confidence,
              communication skills, and a deeper understanding of Indian heritage. Bharatanatyam
              also helps in storytelling, as each gesture and expression holds a unique meaning. With
              its structured technique and meditative quality, Bharatanatyam brings harmony between
              body and soul. Whether you're looking for a creative outlet, physical fitness, or
              spiritual enrichment, Bharatanatyam opens doors to a world of timeless art and inner
              growth. Join our live or online classes and start your journey with experienced
          ...
          {classData.map((cls, index) => (
            <div className="col-md-6 col-lg-4 mb-4" key={cls.id} data-aos="zoom-in" data-aos-delay={index * 100}>
              <div className="class-card">
                <div className="class-image" style={{ backgroundImage: `url(${cls.image})` }}></div>
                  ...
                  <div className="col-md-4 mb-4" key={inst.id}>
                    <div className="card instructor-card shadow">
                      ...
                      <div className="card-body text-center">
                        ...
                        <p className="card-text text-muted">{inst.experience}</p>
                      </div>
                    </div>
                  </div>
                ))}
    ...
    <section className="review-section py-5" id="reviews">
      <div className="container">
        ...
        >
          <div className="carousel-inner">
            {[firstSlide, secondSlide].map((slide, index) => (
              <div
